...
export const COVERAGE_TYPES: CoverageType[] = [
  ...
  },
  {
    ...
    icon: '🦠',
    heroImage: 'https://images.unsplash.com/photo-1527153857715-3908f2bae5e8?w=1400&h=600&fit=crop&auto=format&q=80',
    ...
    longForm: {
      intro: [
        'Disease and illness cover is arguably the most complex — and for many farmers, most critical — component of a comprehensive livestock insurance programme. The first thing to understand is that standard livestock mortality policies do not cover disease. They cover sudden, accidental deaths. Disease cover requires a separate, specifically sought-out product — and in most cases, specialist underwriting not available from mainstream NZ insurers.',
        'The Mycoplasma bovis (M. bovis) outbreak that began in 2017 highlighted the gap. Over 170,000 cattle were culled. The eradication programme is now managed by OSPRI under the M. bovis National Pest Management Plan, targeting nationwide eradication by June 2028. OSPRI provides compensation for government-ordered culling — funded 68% by the Crown and 32% by the dairy and beef industries. However, government compensation is based on schedule prices, not market or replacement value, and does not cover production losses, herd rebuilding, or operational disruption during restrictions. Private disease insurance exists to fill these gaps — but availability and terms depend entirely on species, biosecurity practices, farm history, and current underwriting appetite in the specialty market.',
        'For poultry farmers, avian influenza (bird flu) represents a comparable existential risk — a single outbreak can result in the forced culling of an entire flock within days of detection. Government emergency response provisions may provide some compensation but historically have not covered the full scope of farm losses. For pig farmers, African Swine Fever — not yet established in NZ — represents a biosecurity threat where advance planning matters. Sheep and beef operations also face risks from footrot, facial eczema, and respiratory disease outbreaks.',
        'Where private disease & illness cover can be obtained, it may include: mortality from disease, veterinary treatment costs, forced culling and disposal costs, supplementary compensation above government schedule prices, and loss of production on comprehensive policies. Scope, availability, and eligibility vary widely — this is a specialty insurance product typically placed through brokers with access to specialist or international underwriting markets.',
        'A licensed rural insurance adviser with access to the specialty market is the only way to determine what disease cover is currently available for your specific operation — what is offered, what is excluded, and whether it is worth the premium given your risk profile and the government compensation you may already be entitled to.',
      ],
      whatsCovered: [
        ...
        { title: 'Government Compensation Top-Up', desc: 'OSPRI/government compensation for M. bovis culling is based on schedule prices, not market value. Private insurance can supplement this — covering the gap between schedule price and your actual animal values.' },
      ...
      costGuide: 'Disease & illness cover is a specialty product and premiums depend on species, herd size, location, biosecurity practices, and what the specialist market will offer at that time. For operations where it is available, premiums for a 200-cow dairy operation might range from $500–$2,000+ per year depending on the scope. Importantly, disease cover is not always available — underwriting appetite fluctuates and pre-existing disease history can limit or exclude access. For M. bovis specifically, the government OSPRI programme provides compensation for culling, but production losses and herd rebuilding costs are not covered by OSPRI. A specialist adviser will help you understand both your government entitlements and the private insurance options that can supplement them.',
      howToGetCovered: [
      ...
      faqs: [
        { q: 'Does standard livestock insurance cover Mycoplasma bovis?', a: 'No. Standard livestock mortality policies cover accidental death — not death from disease. For M. bovis specifically, government compensation for government-ordered culling is managed by OSPRI under the national M. bovis programme. OSPRI compensation is based on schedule prices, not market value, and does not cover production losses or herd rebuilding. Private disease insurance may be available through specialist brokers to fill this gap — but eligibility depends on your farm history, biosecurity practices, and current underwriting appetite.' },
        ...
        { q: 'What happens if MPI or OSPRI orders my animals to be culled?', a: 'For M. bovis specifically, OSPRI manages the eradication programme and provides compensation for culled animals based on schedule prices. This does not cover the full market value of your animals or your production losses during the restriction period. If you have private disease insurance, notify your insurer as soon as any MPI/OSPRI investigation begins — before any culling occurs. Your private cover would supplement the OSPRI compensation up to your policy limits.' },
        { q: 'Is private disease cover worth it when OSPRI compensates for M. bovis culls?', a: 'OSPRI compensation covers a portion of the culled animal value at schedule prices — not market value, not breeding value, and not production losses during restriction. For high-value herds or operations where milk production losses would be substantial, private insurance filling this gap can be significant. For other notifiable diseases where no government programme exists, private insurance is the only protection. A specialist adviser can help you model the scenarios most relevant to your operation and risk appetite.' },
      ],
      ...
      externalLinks: [
        { title: 'OSPRI — M. bovis Compensation for Farmers', url: 'https://www.ospri.co.nz/farmers-and-livestock-owners/mycoplasma-bovis/when-your-farm-is-in-the-mycoplasma-bovis-programme/compensation-for-mycoplasma-bovis/' },
        { title: 'MPI — Mycoplasma Bovis National Pest Management Plan', url: 'https://www.mpi.govt.nz/biosecurity/exotic-pests-and-diseases-in-new-zealand/long-term-biosecurity-management-programmes/mycoplasma-bovis-national-pest-management-plan' },
        { title: 'MPI — Report a Biosecurity Risk', url: 'https://www.mpi.govt.nz/biosecurity/pests-and-diseases/reporting-a-biosecurity-risk/' },
  ...
  },
  {
    ...
    icon: '🚛',
    heroImage: 'https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=1400&h=600&fit=crop&auto=format&q=80',
  ...
  },
  {
    ...
    icon: '🌊',
    heroImage: 'https://images.unsplash.com/photo-1504701954957-2010ec3bcec1?w=1400&h=600&fit=crop&auto=format&q=80',
  ...
  },
  {
    ...
    icon: '⚖️',
    heroImage: 'https://images.unsplash.com/photo-1458966480358-a0ac42de0a7a?w=1400&h=600&fit=crop&auto=format&q=80',
  ...
  },
  {
    ...
    icon: '🔒',
    heroImage: 'https://images.unsplash.com/photo-1495107334309-fcf20504a5ab?w=1400&h=600&fit=crop&auto=format&q=80',
