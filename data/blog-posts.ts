...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: `## Why Livestock Insurance Matters in New Zealand
...
**Mortality Cover** is the foundation of livestock insurance. It pays you the agreed or market value of your animal if it dies from a covered cause. Covered causes typically include accidental death, electrocution, drowning, fire, and specified weather events.

**Disease & Illness Cover** compensates farmers when livestock contract notifiable diseases or serious illness. Mycoplasma bovis highlighted this gap for dairy farmers — many discovered too late that their standard farm policy didn't cover forced culling costs.

**Transit Insurance** covers your animals during transport to saleyards, processing plants, or agricultural shows. Transit deaths are more common than most farmers realise.
...
1. **Animal value** — higher value animals cost more to insure
2. **Species** — deer and exotic livestock have higher rates than sheep
3. **Location** — flood-prone regions face higher natural disaster loadings
4. **Claims history** — poor claims history increases premiums significantly
5. **Coverage type** — comprehensive policies with disease cover cost more
6. **Excess level** — higher excess reduces premiums by 20–40%
...
Independent rural insurance advisers can access FMG, Aon, Gallagher, and NZI — and can compare all of these for your specific situation. For dairy farmers with significant herd values, independent comparison is worth the time.`,
  },
  {
    ...
    content: `## Sheep Insurance in New Zealand
...
## The Unique Risks of Deer Farming

Deer present unique insurance challenges:
- They are highly valuable individually (especially stags)
- They are difficult to handle, increasing injury risk
- Velvet removal is a medical procedure with mortality risk
- They are agile and frequently escape, creating liability risk
- Their value is tied to genetics, which is difficult to replace
...
- Include velvet removal procedure mortality
- Consider transit cover for stags used in breeding programmes
- Review values annually as stag genetics appreciates

## Breeding Hind Insurance

While less individually valuable than stags, breeding hinds represent significant herd value in aggregate. Blanket mortality cover is appropriate for commercial hind herds, with disease & illness cover as an add-on.

## Deer Escape Liability

Deer can clear most standard fences and are fast movers. A deer on a road poses a serious accident risk. Farm & livestock liability cover is important for all deer farmers, especially those near main roads.
...
- Death occurring during the velvet removal procedure
...
- Has adequate limits (minimum $1M, ideally $2M+)
- Explicitly covers deer escape scenarios
- Covers damage to vehicles and property off your land`,
  },
  {
...
- Death during road transport
- Injury during loading/unloading
- Death or injury at saleyards (while in your ownership)
- Death or injury at agricultural events
- Some policies cover theft from vehicles or yards
