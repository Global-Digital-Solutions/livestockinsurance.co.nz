...
export const metadata: Metadata = {
  title: 'Compare Livestock Insurance Providers NZ — Aon vs Gallagher vs NZI',
  description: 'Compare livestock insurance providers in New Zealand. Side-by-side comparison of coverage, pricing, and specialist capabilities from leading rural brokers.',
  alternates: { canonical: `${SITE.domain}/compare/` },
};

const rows = [
  { label: 'Best for', aon: 'Complex needs & high-value stud animals', gallagher: 'Exotic livestock, rare breeds & alpacas', nzi: 'Farm pack bundled cover' },
  { label: 'Cattle Cover', aon: '✅ Strong', gallagher: '✅ Good', nzi: '✅ Standard' },
  { label: 'Sheep Cover', aon: '✅ Good', gallagher: '✅ Good', nzi: '✅ Standard' },
  { label: 'Deer Cover', aon: '✅ Good', gallagher: '✅ Good', nzi: '⚠️ Limited' },
  { label: 'Exotic/Rare Livestock', aon: '✅ Via Lloyd\'s', gallagher: '✅ Specialist', nzi: '❌ Minimal' },
  { label: 'Natural Disaster', aon: '✅ Available', gallagher: '✅ Available', nzi: '✅ Available' },
  { label: 'Post-Shearing Exposure', aon: '⚠️ Case by case', gallagher: '⚠️ Limited', nzi: '⚠️ Limited' },
  { label: 'Velvet Removal Cover', aon: '⚠️ Case by case', gallagher: '⚠️ Limited', nzi: '❌ Not standard' },
  { label: 'Agreed Value Cover', aon: '✅ High limits via Lloyd\'s', gallagher: '✅ High limits', nzi: '⚠️ Limited' },
  { label: 'Online Quote', aon: '✅ Yes', gallagher: '⚠️ Broker only', nzi: '✅ Yes' },
];
      ...
      <section className="relative bg-gray-900 overflow-hidden py-14">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white text-lg max-w-2xl">
            Side-by-side comparison of leading rural insurance brokers and specialists — so you can find the right provider for your livestock and farm.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { title: 'Choose Aon if...', desc: "You have complex coverage needs, high-value stud animals requiring agreed values, or a mixed operation with unusual coverage requirements. Aon's Lloyd's market access provides flexibility that standard farm insurers can't always match.", color: '#1e40af' },
              ...
              { title: 'Consider NZI if...', desc: "You want a comprehensive farm pack that bundles property, equipment, and livestock cover in one policy. NZI is competitive on farm pack pricing and good for standard farm operations.", color: '#374151' },
            ].map((v) => (
